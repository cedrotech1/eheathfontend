        ...
        <div class="items-container">
          <div class="item">
            <div class="inner-box">
              <div class="img_holder">
                <a href="service.html">
                  <img loading="lazy" src="asset/images/gallery/1.jpg" alt="images" class="img-fluid"/>
                </a>
              </div>
          ...
          <div class="item">
            <div class="inner-box">
              <div class="img_holder">
                <a href="service.html">
                  <img loading="lazy" src="asset/images/gallery/2.jpg" alt="images" class="img-fluid"/>
                </a>
              </div>
              <div class="image-content text-center">
                <span>Better Service At Low Cost</span>
          ...
          <div class="item">
            <div class="inner-box">
              <div class="img_holder">
                <a href="service.html">
                  <img loading="lazy" src="asset/images/gallery/3.jpg" alt="images" class="img-fluid"/>
                </a>
              </div>
              <div class="image-content text-center">
                <span>Better Service At Low Cost</span>
    ...
    <div class="row justify-content-center">
      <div class="col-lg-4 col-md-6">
        <div class="team-member">
          <img loading="lazy" src="asset/images/team/doctor-2.jpg" alt="doctor" class="img-fluid"/>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="team-member">
          <img loading="lazy" src="asset/images/team/doctor-lab-3.jpg" alt="doctor" class="img-fluid"/>
          <div class="contents text-center">
            <h4>Dr. Marry Lou</h4>
            <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Dignissimos, aspernatur.</p>
            <a href="appointment.html" class="btn btn-main">Book Appointment</a>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="team-member">
          <img loading="lazy" src="asset/images/team/event-2.jpg" alt="doctor" class="img-fluid"/>
          <div class="contents text-center">
        ...
        <div class="testimonial-carousel">
          ...
          <div class="slide-item">
            <div class="inner-box text-center">
              <div class="image-box">
                <figure>
                  <img loading="lazy" src="asset/images/testimonials/2.png" alt=""/>
                </figure>
              </div>
              <h6>David Warner</h6>
              <p class="mb-0">Neque porro quisquam est, qui dolorem ipsum quia consectetur, dolor sit amet, consectetur, numquam Lorem
          ...
          <div class="slide-item">
            <div class="inner-box text-center">
              <div class="image-box">
                <figure>
                  <img loading="lazy" src="asset/images/testimonials/3.png" alt=""/>
                </figure>
              </div>
              <h6>Amy Adams</h6>
              <p class="mb-0">Neque porro quisquam est, qui dolorem ipsum quia consectetur, dolor sit amet, consectetur, numquam Lorem
